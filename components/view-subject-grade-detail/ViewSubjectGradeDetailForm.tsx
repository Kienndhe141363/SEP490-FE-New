        ...
        <table className="w-full mt-10 table-auto border-collapse rounded">
          <thead>
            <tr className="bg-[#6FBC44] text-white">
              ...
              <th className="px-6 py-3 text-center tracking-wider">Asignment 1</th>
              <th className="px-6 py-3 text-center tracking-wider">Asignment 2</th>
              <th className="px-6 py-3 text-center tracking-wider">Asignment 3</th>
