...
const ViewClassDetailForTrainerForm: React.FC = () => {
  return (
        ...
        <div className="p-10">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-10">
            <div className="grid grid-cols-2 gap-x-20 gap-y-8">
              ...
              <div>
                <label className="block text-2xl font-bold mb-2">Trainee No.</label>
                <p className="text-xl p-3 border rounded-lg border-gray-300">20</p>
              </div>
              ...
              <div>
                <label className="block text-2xl font-bold mb-2">Supplier</label>
                <p className="text-xl p-3 border rounded-lg border-gray-300">FA GPS</p>
              </div>
              <div>
                <label className="block text-2xl font-bold mb-2">Syllabus</label>
...
export default ViewClassDetailForTrainerForm;